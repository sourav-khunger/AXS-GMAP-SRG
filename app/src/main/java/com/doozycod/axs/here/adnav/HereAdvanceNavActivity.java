package com.doozycod.axs.here.adnav;
 ...
 */
public class HereAdvanceNavActivity extends AppCompatActivity {
    ...
    private MapAdNavFragmentView m_mapFragmentView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_here_adnav);
    ...
    private void setupMapFragmentView() {
        ...
        m_mapFragmentView = new MapAdNavFragmentView(this);
    }
