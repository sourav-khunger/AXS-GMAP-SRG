package com.doozycod.axs.here.turn;
...
public class HereTurnForegroundService extends Service {

    public static int FOREGROUND_SERVICE_ID = 101;

    public static String START_ACTION = "com.unipos.axslite.fs.action.start";
    public static String STOP_ACTION = "com.unipos.axslite.fs.action.stop";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent.getAction().equals(START_ACTION)) {
            Intent notificationIntent = new Intent(this, HereTurnNavActivity.class);
